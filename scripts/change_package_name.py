    ...
    for root, dirs, files in os.walk(project_path):
        ...
        for file in files:
            ...
            if file.endswith('.kts') or file.endswith('.gradle'):
                file_path = os.path.join(root, file)
                replace_in_file(file_path, 'implementation ("io.hyphenate:hyphenate-chat:4.11.0")', 'implementation ("io.agora.rtc:chat-sdk:1.3.1-beta")')
...
if __name__ == "__main__":
    ...
    old_package = "com.hyphenate.chatroom"
    new_package = "io.agora.chat.uikit.chatroom"
